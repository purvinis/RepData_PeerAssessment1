...
If the lubridate package funcion qday() is applied to the $date variable in the activity dataframe, the day of the quarter is returned. There are 61 unique days. To create the histogram data, the steps for each day are summed. Zeros in the step data are replaced with NAs to get the correct mean and median.
```{r StepInADay}
